  ...
  ">
    ...
    <div style="position:relative;z-index:1;">
      ...
      <div style="display:flex;flex-direction:column;gap:12px;align-items:flex-start;">
        <a href="https://www.dropbox.com/scl/fo/iv0xe7trxc1qo5d80l6b9/APu4LvbsX47kwoYi62hZXnw?e=1&fbclid=IwY2xjawSI1nJleHRuA2FlbQIxMABicmlkETFmYUNpM0dSTFRHZ2ZmcDl2c3J0YwZhcHBfaWQQMjIyMDM5MTc4ODIwMDg5MgABHoC3sGC3zXZcDHYr9tmWDzIWQiwBMh4HYvb5kLpqEGzeW_IlNbHIjW5H8D-2_aem_UHqby6QTdoQg_oxM38nFZw&rlkey=ke2htuqmydbfutke9meuv5j57&st=t3cdgd9r&dl=0" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:12px;background:var(--primary);color:#000;text-decoration:none;padding:14px 24px;border-radius:14px;font-weight:700;font-size:.92rem;box-shadow:0 6px 24px color-mix(in srgb,var(--primary) 40%,transparent);transition:all .22s;border:none;" onmouseover="this.style.transform='translateY(-2px)';this.style.filter='brightness(1.1)'" onmouseout="this.style.transform='';this.style.filter=''">
