...
.sb-tenant-name{font-size:.85rem;font-weight:700;color:#ffffff;}
...
.sb-item{display:flex;align-items:center;gap:10px;padding:9px 14px;margin:1px 8px;border-radius:10px;cursor:pointer;color:rgba(255,255,255,.75);font-size:.82rem;font-weight:500;text-decoration:none;transition:all .18s;}
.sb-item:hover{background:rgba(255,255,255,.08);color:#ffffff;}
.sb-item.active{background:color-mix(in srgb,var(--t-primary,#10b981) 12%,transparent);color:var(--t-primary,#059669);font-weight:600;}
...
.page-hdr p{font-size:.78rem;color:rgba(255,255,255,.45);margin-top:2px;}
...
.btn-sm{padding:5px 11px;border-radius:7px;font-size:.72rem;font-weight:600;cursor:pointer;border:1px solid #e4e6eb;background:#f0f2f5;color:#1c1e21;text-decoration:none;display:inline-flex;align-items:center;gap:4px;transition:all .15s;font-family:inherit;}
...
.finput{width:100%;border:1.5px solid #e4e6eb;border-radius:10px;padding:9px 12px;font-family:inherit;font-size:.85rem;color:#1c1e21;outline:none;background:#f7f8fa;transition:border .2s;}
.finput:focus{border-color:var(--t-primary,#10b981);box-shadow:0 0 0 3px color-mix(in srgb,var(--t-primary,#10b981) 15%,transparent);background:#fff;}
