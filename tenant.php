  ...
  <?php elseif($active_page==='tickets'): ?>
    <div class="card" style="overflow-x:auto;">
      ...
      <tr>
        ...
        <td style="font-weight:600;color:<?=$is_light_mode?'#1c1e21':'#fff'?>;"><?=htmlspecialchars($t['customer_name'])?></td>
        <td style="font-size:.78rem;font-family:monospace;"><?=htmlspecialchars($t['contact_number']??'—')?></td>
        <td><?=htmlspecialchars($t['item_category'])?></td>
        <td>₱<?=number_format($t['loan_amount'],2)?></td>
        <td style="font-weight:700;color:<?=$is_light_mode?'#1c1e21':'#fff'?>;">₱<?=number_format($t['total_redeem'],2)?></td>
