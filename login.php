...
.btn {
  ...
  box-shadow: 0 5px 16px rgba(30,58,138,0.28);
...
.card-foot a { color: #1e3a8a; font-weight: 700; text-decoration: none; }
...
<main class="page">
  <div class="panel">
    ...
    <div class="card">
      ...
      <div class="card-icon">
        <span class="material-symbols-outlined" style="font-size:2rem;color:#1e3a8a;">diamond</span>
      </div>

      <h1 class="card-title">Welcome Back</h1>
      <p class="card-sub">Enter your credentials to access the PawnHub platform.</p>
