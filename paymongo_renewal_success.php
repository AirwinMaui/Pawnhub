...
<title>Renewal Payment Received — PawnHub</title>
...
<div class="bg-gray-900 border border-gray-800 rounded-3xl p-10 max-w-lg w-full text-center shadow-2xl">
  ...
  <h1 class="text-2xl font-extrabold mb-2">Renewal Payment Received! 🎉</h1>
  ...
  <div class="bg-gray-800 rounded-2xl p-6 mb-6 text-left">
    ...
    <div class="flex items-start gap-3 mb-4">
      ...
      <div>
        <p class="text-sm font-semibold text-white">Renewal payment confirmed</p>
