...
.sb-footer{padding:12px 14px;border-top:1px solid rgba(255,255,255,.06);position:sticky;bottom:0;background:rgba(8,11,18,0.97);z-index:101;margin-top:auto;}
