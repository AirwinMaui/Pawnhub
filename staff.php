...
.btn-primary-xs{background:var(--t-primary,#2563eb);color:#000 !important;border:1.5px solid rgba(0,0,0,.25);box-shadow:0 2px 8px rgba(0,0,0,.18);font-weight:800;}
