    ...
    if (empty($_POST['agree_terms'])) {
        ...
        if ($file_size > 5 * 1024 * 1024) {
            ...
            if ($chk_user->fetch()) {
                ...
                $error = 'A business with that name is already registered. Please use a different business name or contact support.';
            } else {
